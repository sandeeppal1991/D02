...
def check_one_set(a,b,c):
    if( a + b < c):
        return False
    else: return True

def is_triangle(a,b,c):
    if(check_one_set(a,b,c) and check_one_set(b,c,a) and check_one_set(a,c,b)):
        print("Yes")
    else:
        print("No")
def check_stick_lengths():
    a = int(input("Enter a side value: "))
    b = int(input("Enter a side value: "))
    c = int(input("Enter a side value: "))
    is_triangle(a,b,c)
